  ...
  render() {
    ...
    return (
      ...
      >
        {requirements &&
          ...
          <ul className="input-requirements">
            {requirements.map(requirement => (
              <li className="input-requirement" key={requirement.description}>
                <span>{requirement.description}</span>
                <span
                  className={
                    requirement.validate(this.state.value)
                      ? 'valid-requirement'
                      : 'hidden'
                  }
                >
                  <i className={icons.valid} />
                </span>
              </li>
            ))}
          </ul>
        ...
        <span
          className={`input-icon ${this.state.focus ? 'with-focus' : ''}`}
        />
        <input
          {...rest}
